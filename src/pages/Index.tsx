...
const Index = () => {
  ...
  const downloadCV = () => {
    ...
    link.href = '/assets/resume/Gardiola_Mark_Louise_QA_Resume.pdf';
      ...
      <section id="home" className="min-h-screen flex items-center justify-center relative pt-24 pb-32">
        <div className="relative z-10 text-center text-white px-4 scroll-fade-in">
          ...
          <div className="flex justify-center space-x-6 mb-12 scroll-fade-in">
            <a href="https://github.com/GardiolaMarkLouise/" className="text-white hover:text-purple-400 transition-all duration-300 hover:scale-110">
              <Github className="w-8 h-8" />
            </a>
            <a href="https://linkedin.com/in/mrklgrdl1124" className="text-white hover:text-purple-400 transition-all duration-300 hover:scale-110">
              <Linkedin className="w-8 h-8" />
            </a>
            <a href="mailto:marklouise.gardiola1124@gmail.com" className="text-white hover:text-purple-400 transition-all duration-300 hover:scale-110">
                  ...
                  <Card key={tech.name} className={`bg-black/40 backdrop-blur-xl border-purple-500/30 space-card hover-scale group scroll-scale-in`} style={{animationDelay: `${index * 0.1}s`}}>
                    <CardContent className="p-4 aspect-square flex flex-col items-center justify-center text-center">
                      <div className="w-10 h-10 mb-3 rounded-lg overflow-hidden group-hover:scale-110 transition-transform duration-300">
                        <img
                          src={`/assets/techstack/${tech.logo}?w=40&h=40&fit=crop`}
                          alt={`${tech.name} logo`}
            ...
            {[
              {
                ...
                logo: "/assets/company/befied_logo.jpeg?w=200&h=200&fit=crop&crop=center",
                alignment: "left"
              },
              {
                ...
                logo: "/assets/company/easypos_logo.jpeg?w=200&h=200&fit=crop&crop=center",
                alignment: "right"
              },
              {
                title: "Quality Assurance Engineer (Intern)",
                ...
                logo: "/assets/company/skydev.jpg?w=200&h=200&fit=crop&crop=center",
                alignment: "left"
              }
            ].map((job, index) => (
            ...
            {[
              ...
              <Card key={index} className="bg-black/40 backdrop-blur-xl border-purple-500/30 space-card hover-scale group scroll-scale-in" style={{animationDelay: `${index * 0.1}s`}}>
                <CardContent className="p-6 text-center">
                  ...
                  >
                    <img
                      src={`/assets/certifications/${cert.image}?w=400&h=300&fit=crop`}
            ...
            {[
              ...
              <Card key={index} className="bg-black/40 backdrop-blur-xl border-purple-500/30 space-card hover-scale group scroll-scale-in" style={{animationDelay: `${index * 0.2}s`}}>
                <div className="relative overflow-hidden rounded-t-lg">
                  <img
                    src={`/assets/projects/${project.image}?w=400&h=250&fit=crop`}
                    alt={project.title}
                ...
                <CardContent className="p-6 text-center">
                  ...
                  <div className="mb-6">
                    <Avatar className="w-16 h-16 mx-auto mb-4 cosmic-avatar">
                      <AvatarImage 
                        src={`/assets/testimonials/${testimonial.image}?w=200&h=200&fit=crop&crop=face`}
